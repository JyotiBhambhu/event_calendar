...
import com.jyoti.eventcalender.week.model.getWeekCalendarAdjustedRange
import com.jyoti.eventcalender.week.model.getWeekCalendarData
import com.jyoti.eventcalender.week.model.getWeekIndex
import com.jyoti.eventcalender.week.model.getWeekIndicesCount
...
class WeekCalendarState internal constructor(
    ...
    internal val listState = run {
        ...
        val item = visibleItemState ?: run {
            VisibleItemState(firstVisibleItemIndex = getScrollIndex(firstVisibleWeekDate).orZero())
        }
        LazyListState(
